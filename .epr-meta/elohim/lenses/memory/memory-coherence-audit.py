...
Usage:
  ...
  python3 .epr-meta/elohim/lenses/memory/memory-coherence-audit.py --json-only
  git diff --name-only origin/dev | \\
    python3 .epr-meta/elohim/lenses/memory/memory-coherence-audit.py --changed -
  python3 .epr-meta/elohim/lenses/memory/memory-coherence-audit.py --since origin/dev
"""
