...
Run: python3 .epr-meta/elohim/lenses/memory/__tests__/memory_coherence_audit_test.py (exit 0 = pass).
...
_audit_path = here / ".epr-meta/elohim/lenses/memory/memory-coherence-audit.py"
