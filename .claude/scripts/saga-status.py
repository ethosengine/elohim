...
(sibling to spine-status.py's delivery-spine headline — same posture: never throw, degrade on
...
def find_repo_root() -> Path:
    ...
    (has .git AND genesis/); fall back to the fixed depth spine-status.py also assumes
