...
check("process gospel (.claude CLAUDE.md)", cls(".claude/scripts/CLAUDE.md") == "process-gospel")
check("process gospel (LIFECYCLE.md)", cls(".epr-meta/elohim/lenses/LIFECYCLE.md") == "process-gospel")
...
check("entry carries tools", isinstance(e["tools"], list) and any("epr flow cites" in t for t in e["tools"]))
