...
metadata:
  ...
  master: package
  governance: "epr:elohim-agent/agents/component-architect"
---
...
**REQUIRED EYES:** before any visual verdict or story review, follow the `looking-at-frontend` skill — Read `.claude/skills/looking-at-frontend/SKILL.md` (you have no Skill tool). It is your eyes: `pnpm graphos story|sheet` (from `genesis/a2o`) renders your stories to a `shot.png` you can Read. Never judge rendering from source alone.
