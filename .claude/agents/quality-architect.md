...
When `genesis/a2o/reports/coverage-gap-report.json` exists (generated by the BDD gap scanner in CI or locally via `cd genesis/a2o && npm run scan:coverage`), incorporate it into your analysis:
