...
description: "holo_hash fields in conductor app signals are msgpack BYTE ARRAYS — any rmp→serde_json::Value pre-pass or String-typed mirror silently drops them; CLASS CLOSED 2026-06-13: all four subscriber families (infra d33b0e1f5, mishpat 73b665122, REA+content 2571fe642) on typed HoloHashB64 decoders"
metadata: 
  node_type: memory
  type: project
