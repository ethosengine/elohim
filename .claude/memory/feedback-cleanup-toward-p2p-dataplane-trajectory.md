...
id: feedback-cleanup-toward-p2p-dataplane-trajectory
description: "Per-host/per-row blob modeling is MVP scaffold toward the P2P dataplane — clean drift, never extend it."
metadata: 
  node_type: memory
  type: feedback
