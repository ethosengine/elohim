...
id: project-agent-eyes-look-live-peer-loop
description: "pnpm look (a2o) renders any URL to a shot.png I can Read; pnpm start:alpha runs the local UI on live alpha data with no local stack."
metadata: 
  node_type: memory
  type: project
