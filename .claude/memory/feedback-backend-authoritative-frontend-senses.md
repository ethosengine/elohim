...
id: feedback-backend-authoritative-frontend-senses
description: "Backend owns view types (view schema + manifest); Rust conforms, codegen projects to TS; the UI never dictates."
metadata: 
  node_type: memory
  type: feedback
