...
description: "Serving: new 8080 routes need is_service_path; poisoned scope row empties EprRouter; EPR GETs divert to SSR; first SSR deploy = seed then restart."
metadata:
  node_type: memory
  type: project
---
