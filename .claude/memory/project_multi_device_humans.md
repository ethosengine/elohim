...
---
Each human persona in the Elohim deployment represents a real person with multiple devices, not a single k8s pod. Matthew has a node (bootstrap/doorway host), a primary device, plus mobile devices (tablet, phone). Jessica has the same shape. Timothy is a stewarded child with a Chromebook-class device dependent on his parents' nodes.
