...
---
Household nodes are not static. Family members bring hardware when they arrive (grandma moves in with two blades) and take hardware when they leave (Timothy takes a node to college). The elohim operator is expected to:
