...
description: "Record stale gospel/memory claims via `epr flow note --kind correction`; ceremony Phase 0 reads them — bites when a claim is found stale mid-task."
metadata:
  type: feedback
---
