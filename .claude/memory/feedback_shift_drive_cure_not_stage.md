...
description: In a shift you own the cure end-to-end — stabilize with the obvious lever first, then drive the durable fix; don't hide behind "staged/gated" when you have diagnosis + scope + budget.
metadata:
  type: feedback
---
