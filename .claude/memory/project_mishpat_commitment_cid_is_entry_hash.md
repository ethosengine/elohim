...
id: project-mishpat-commitment-cid-is-entry-hash
description: "Commitment cid = entry_hash (keys bounded_by/graduate/revoke/fetch); action_hash is only dht_anchor_hash — returning it breaks every bounds-gate."
metadata: 
  node_type: memory
  type: project
