...
title: "DNS premises + anycast doorway names (umbrella)"
id: project-two-premises-dns-beacon-owned
description: "apex=shem/adam, alpha=operations/matthew, beacon-owned; doorways stand anycast behind names and subsume the ingress."
metadata: 
  node_type: memory
...
- [[project_doorways_subsume_ingress_anycast_names]] — folded 2026-09-22 (index: false); Doorways are host-aware and stand anycast-style behind a name's DNS records, failing over for each other; the k8s ingress goes away — bites on any serving-edge design.
