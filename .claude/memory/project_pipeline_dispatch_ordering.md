...
id: project-pipeline-dispatch-ordering
description: "Live-target gates deadlock; same-wave bakes PREVIOUS happ; coordinator changes keep DNA hash; build path moves it."
metadata:
  node_type: memory
  type: project
---
...
- [[project_dna_hash_depends_on_build_path]] — folded 2026-09-22 (index: false); Cargo metadata includes package paths: identical source in different worktrees changes DNA hashes — check before hash comparisons or coordinator hot-swap.
