...
| [justice-manifesto](epr:justice-manifesto) | `justice-manifesto.md` | The justice that *sees* (El Roi, not the blindfold) as stewardship, not sovereignty — impartiality from incorruptible, witnessed sight, not from not-seeing. The floor (human sortition) and the ceiling (the elohim); non-coercion and the parallel-system boundary (witnessed, appeal-permeable, not compellable); the inviolable-dignity floor (Basic Law Art. 1 / Halden); the hole in justice held by faith; POSIWID self-judgment; the LLM as imago-dei mirror, never enthroned. Points down to the [elohim-ceiling-design](epr:elohim-ceiling-design) spec. |
