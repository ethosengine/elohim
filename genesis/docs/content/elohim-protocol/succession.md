...
cites:
  - "elohim-protocol-manifesto | The vision this document clears the ground for — the crisis it answers and the love-centered alternative it proposes, which a reader arriving with a formed politics will not see until the older argument is settled. | sha256:c1b65508df47bcaa | path: genesis/docs/content/elohim-protocol/manifesto.md"
  - "values-forward | The thirteen Stances this document treats as settled law — most of all I.1 (the commons owned by no one), I.2 (not a blockchain and not a token), I.4 (the common inheritance), II.4 (stewardship over sovereignty), and IV.2 (enforcement by participation, never coercion). | sha256:80a6f4eeeefa1ffd | path: genesis/docs/content/elohim-protocol/values-forward.md"
  - "constitution | The law that operationalizes the vision — the layer precedence and the universal gate this document's refusals inherit. | sha256:2dda7f102ca76eb9 | path: genesis/docs/content/elohim-protocol/constitution.md"
  - "confession | The theology beneath the vision, and the discipline this document's most present-tense claim answers to: leaven, not the Kingdom. | sha256:dff3a6835bfa3802 | path: genesis/docs/content/elohim-protocol/confession.md"
...
> **The claim this document argues, and hedges where it must:** a witnessed-event substrate with a local AI reader collapses all five costs. That collapse is not a feature of the protocol; it is the protocol's economic content.

The four transactional costs are a hypothesis with a measurement waiting to be taken (§5.2, §11); the fifth is further from evidence than that (§11). Both caveats are stated where the claims are made, not held back for the end — but a reader who wants them now should read §11 first. On the four transactional costs it extends a known result — that commons-based peer production out-competes both firms and markets once coordination costs fall far enough — from information goods to credit, care, and public-good provision. On the fifth it does something the tradition never had available: **it makes the good life stop being hostage to the reform.**
...
**It is counter-cyclical.** James Stodder's empirical work on Swiss data (*Journal of Economic Behavior & Organization*, 2009) has found WIR turnover moving *against* GDP: when the franc economy contracts and commercial credit withdraws, WIR volume rises. That is the strongest evidence in existence for the claim that a second, differently-behaved medium of exchange is a stabiliser rather than a curiosity.

**And it paid for it.** WIR took a Swiss banking licence in 1936 and **dropped Gesell's demurrage in 1948** — demurrage being the carrying cost on held money described above, the mechanism of *Freigeld*. It survived by becoming a regulated cooperative bank doing unglamorous work — assessing members, taking collateral, filing liens in Swiss courts when someone defaulted. The Gesellian mechanism turned out to be the part that could be discarded. The *institutional apparatus* was the part that could not.
...
The honest claim is therefore **not** that the calculation problem is solved. It is that **no calculation is being attempted**: computation stays local, aggregation is voluntary and anonymised, and the global layer holds no allocative authority. This is requisite variety — Ashby's principle that a system's internal diversity must match the diversity of what it governs — and polycentric governance, not a planning board. Any design in this project that starts allocating from an aggregate has crossed that line and should be read as a defect — which §9.2 does, to our own manifesto.
...
**Before the figures, their provenance — because this is the section you were told to check first, and you should know exactly what grade of evidence you are being handed.** The 2026 datacenter and capex numbers below were web-sourced on 2026-08-23 in a single pass and have **not** been cross-checked against primary filings. They are itemised, with that grading, in the evidence bridge named in §12, which states the rule this document is bound by: *verify against primary sources before reuse.* They are the most citation-exposed claims here and the ones a hostile reader will check first — so check them. **The structural argument does not rest on any single figure**: that the grid and the tax base are common inheritance, that abatement plus cost-shift is unearned-increment capture, and that the bottleneck is consent, all survive the loss of any one number. If several are wrong, the section is wrong, and this paragraph is how you would find that out.
