...
cites:
  ...
  - "constitution | The law these stances are the reasons for — the layered, graduated-immutability governance. The constitution binds; this document explains what it binds us to and why. | sha256:2974a0183c02697c | path: genesis/docs/content/elohim-protocol/constitution.md"
  ...
  - "confession | The theology beneath the vision and the honest edges it cannot resolve — the ground of the humility clause (Stance V.1). | sha256:dff3a6835bfa3802 | path: genesis/docs/content/elohim-protocol/confession.md"
...
**And the gradient runs in both directions, which we say plainly because the alternative is a claim we have not earned.** The cession above is a reading of what has been *demonstrated* — of how the pen has actually been captured, repeatedly, in the record we have. It is not a verdict on human capacity, and the honest position on what humans could hold is that **nobody knows**, because most of the proposals have never been run. Sortition at national scale is one such untested theory; there are others, and there are almost certainly forms nobody has thought of yet. None of them is refuted. They are simply unexplored, because the world has never offered a place to try them at a survivable cost.

**That place is what the protocol actually contributes here.** A substrate that can simulate, deliberate, and run real experiments at its edges — reversibly, at low stakes, with the results witnessed — turns governance questions that were once pure improbability into things a community can *attempt*. Patterns that could never before be tested can now be tried, refined, discarded, or proven. And whatever proves itself earns its reach exactly as any other claim here must, whereupon the ceiling it has earned returns to human hands, held as a key alongside the elohim rather than in place of them. The graduation is evidence-shaped and revisable by evidence; a limit that could never return would be a permanent verdict, and we do not have grounds to render one. What emerges through this medium over time is genuinely unpredictable — that unpredictability is the point rather than a caveat on it, and a protocol claiming otherwise would be asserting the foresight it denies to everyone else.
