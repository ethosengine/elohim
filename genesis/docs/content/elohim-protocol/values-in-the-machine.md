...
cites:
  - "elohim-protocol-manifesto | The vision this piece bridges from — the crisis diagnosis and the love-centered alternative, stated as conviction before architecture. | sha256:cd62d3cc869bada5 | status: stale — target content moved on; re-verify | path: genesis/docs/content/elohim-protocol/manifesto.md"
  - "constitution | The law that operationalizes these values — the layered, graduated-immutability governance the 'rules as a constitution you live inside' choice points to. | sha256:1eb96af782012fc6 | status: stale — target content moved on; re-verify | path: genesis/docs/content/elohim-protocol/constitution.md"
  ...
  - "confession | The theology beneath the vision — what the protocol is for and the honest edges it cannot resolve. | sha256:bec001fd41230c67 | status: stale — target content moved on; re-verify | path: genesis/docs/content/elohim-protocol/confession.md"
---
