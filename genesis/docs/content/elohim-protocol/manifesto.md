...
cites:
  - "constitution | The law that operationalizes this vision: the constitution-as-system-prompt, layer precedence (more-immutable wins), and the Matthew 6:21 gate that binds even the lawgiver. | sha256:2974a0183c02697c | path: genesis/docs/content/elohim-protocol/constitution.md"
