...
What makes this more than a slower filter is **attunement**. A filter asks whether you look like a human. An elohim attuned to you asks whether you are consistent with yourself. What a person states about who they are and who they want to be, we call their *imagodei*, the image they hold of themselves, gathered through self-reflection tools (*psephos* instruments) that the person also uses to see themselves. What they reveal through how they actually learn, attend and respond, observed over time, we call *sophia*. The negotiation between the two is continuous, reviewed with the person, and always shown to them so they can contest it. Under that design a neurodivergent person is measured against their own baseline, not a population template, and an elohim attuned to that shape can recognise them where a liveness check would fail them. The picture an agent composes of a person from what they state and reveal does not gate their humanity; it reveals it. And the same attunement, pointed at care instead of verification, is what lets an elohim show up for that person at the moment of need.
