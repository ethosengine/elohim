...
cites:
  ...
  - "values-forward | The conclusions this vision's implicit choices have hardened into: thirteen numbered Stances stating the position, where the field lands, how it was reached, and what it refuses in advance. Where this manifesto and a Stance appear to differ, the Stance is the settled reading. | sha256:80a6f4eeeefa1ffd | path: genesis/docs/content/elohim-protocol/values-forward.md"
  - "shefa-economic-infrastructure | The economic pillar where the Sybil answer was first written down (§5): identity witnessed socially by the people who know you, attesters staking their own standing, no identity score; the Witnessed Humanity section generalises that answer from claiming value to every act of participation. | sha256:74323616b4696d99 | path: genesis/docs/content/elohim-protocol/shefa.md"
  - "imagodei-surfaces | The three identity surfaces; its self-knowledge surface (stated preferences gathered by self-reflection instruments, revealed preferences observed) is the stated-and-revealed negotiation the Witnessed Humanity section calls attunement. | sha256:e0abac6f6a6a0906 | path: genesis/docs/content/elohim-protocol/architecture/imagodei-surfaces-design.md"
  - "stewardship-over-sovereignty | Foundational canon: cryptography as accelerator never gate, the grandma standard, every authority surface with a non-cryptographic recovery path; why witnessed humanity is a relationship and not a key or a filter. | sha256:995eb2079924ea2e | path: genesis/docs/architecture/stewardship-over-sovereignty.md"
  - "private-thought-governed-fruit | The line the Witnessed Humanity section keeps drawn: only what is said and done in shared space is judged; the composed context that reveals a person is never aggregated, imported or joined by an outside observer. | sha256:5b6f5cdb858277e4 | path: genesis/docs/architecture/private-thought-governed-fruit.md"
  - "human-participant-actor-plane-design | The identity and witness design: a human is a first-class participant, never derived from a code host, an email or a git author; an agent present with them can witness them, signed from the device, contestable, and the human keeps the right to claim for themselves and to contest. | sha256:07cc5f8abf194381 | path: genesis/docs/superpowers/specs/2026-09-23-human-participant-actor-plane-design.md"
  - "sense-respond-governance-classifier | The afferent nerve the Witnessed Humanity section names: a selective classifier whose abstention is the escalation trigger, the elohim as endpoint of sensing under the sovereign human sortition floor, advisory sensing never a terminal deny. | sha256:c716a519ee6cc953 | path: genesis/docs/superpowers/specs/2026-07-15-sense-respond-governance-classifier-design.md"
  - "observer-protocol | The epic that completes the Witnessed Humanity arc with a body: ephemeral physical witness under a mechanical privacy switch, correlating the person the agent is attuned to with the person the household own eyes have seen; its Sybil section is the physical half of the same answer. | sha256:f179602d25f1b4bd | path: genesis/docs/content/elohim-protocol/observer-protocol.md"
  - "eprfs-witnessed-interaction-primitive | Witness, do not pay: attention is denominated in the witnessable and self-report stays advisory forever; the consumer-blinded census is why the revealing context in the Witnessed Humanity section is never aggregated. | sha256:6a24773ffd7b83f4 | path: genesis/docs/superpowers/specs/2026-07-15-eprfs-witnessed-interaction-primitive-design.md"
---
...
3. **Graduated consensus requirements** - Changes require increasingly difficult consensus as you move up layers, and what sits at the top got there by graduating. A concern starts human-shaped — negotiable, local, held by the people it touches — and moves toward the global layer as it stops being anyone's produce and becomes everyone's: land, natural monopoly, network position, the aggregations that return value without labor. Once a concern has graduated, global change over it requires consensus among the Elohim themselves rather than a vote, because a vote is the instrument that has most often been turned to capturing exactly this. Communities keep wide authority over how universal principles are expressed in their own context, and the authorship of the values stays human throughout; what no majority gets is an exemption from a limit that protects everyone else. This is a reading of the record, not a verdict on human capacity — and the gradient runs both ways. Most of what humans might use to hold a ceiling has never been tried: sortition at national scale is one untested proposal among several, and the forms that finally work may be ones nobody has thought of yet. What the protocol offers is somewhere to find out — a substrate where such patterns can be simulated, deliberated, and actually run at the edges, reversibly and at survivable cost, so that what was pure improbability becomes something a community can attempt. Whatever proves itself there earns its reach like anything else here, and the ceiling returns to human hands as a key held alongside the elohim. What this medium grows into is genuinely unpredictable, and that is the point rather than an apology for it.
...
### **Witnessed Humanity: Attunement, Not Filters**

Every open network eventually meets the same attack. One actor pretends to be many: it can open a thousand accounts and cast a thousand votes, all from one hand. The literature calls it the Sybil problem, and every prior answer to it has been a filter: a captcha, a phone number, a credit card, a government document, a liveness selfie, a biometric hash. A filter compares a person to a template of "human" and admits whoever matches. Two things follow. Anyone the template did not anticipate is failed by it, and the template itself becomes the thing an attacker learns to pass. Filters are tests, and an adversarial AI is a machine for passing tests. As such systems grow more capable, filters shut out more real people while letting more fakes through.

The Elohim Protocol does not answer the Sybil problem with a better filter. It answers it the way people always have: by asking the people who know you. Humanity here is **witnessed**, never self-declared and never inferred by the underlying network. A witness is a participant, human or elohim, who takes responsibility for a statement about another person, signs it from the device they act on, names the basis they stand behind, and can be contested by anyone who can show evidence otherwise. Each witness stakes their own standing on the word, standing being the trust others have extended to them through what they have done in shared space. A ring of invented identities that vouch only for one another has no one outside the ring to vouch for it, and a thousand fake people need a thousand real histories of people who know them. The elohim keep the record and help a person gather it; they do not decide it, and no identity score is ever produced.

What makes this more than a slower filter is **attunement**. Attunement means paying close, patient attention to one person until you know them. A filter asks whether you look like a human. An elohim attuned to you asks something else. It asks whether you are consistent with yourself. Part of what it learns is what you say about who you are and who you want to be. That is gathered with self-reflection tools you also use to see yourself. Part of it is what you show by how you actually learn, pay attention and respond. That is noticed slowly, over time. Neither of these is you. Under both is what this protocol calls your *imagodei*. The word means the image of God in a person. It is something in each of us that nobody makes and nobody owns, not even you. The word comes from this protocol's own roots. But anyone can hold the idea in their own terms. The protocol stays open to every honest belief that does, including other faiths. The network does not decide what that identity is. It comes near it with humility, as something that must never be violated. That humility is a firm rule, not just good manners. It is what lets the network make this claim honestly and keep making it. It also marks the one failure the protocol will not allow. That failure is a person, or a system, that puts itself in that place and uses power over others that it never earned. The elohim get the same respect. The way they are built makes them a reflection of that image too. The same limit applies to them. So a person whose mind works differently from most is compared with their own normal, not with an average of everyone else. An elohim that knows their shape can recognise them when a standard test for being a live human would fail them. The picture an elohim builds of you from what you say and show does not decide whether you count as human. It shows your humanity. The same close attention, used to care for you instead of checking you, lets an elohim be there for you when you need it most. The back-and-forth between what you say and what you show never stops. It is talked through with you. It is always shown to you so you can push back on it.

It also inverts the adversary's problem. Faking a template is cheap. Faking a whole person is not: the revealed history, the relationships that cost something, the rhythm of attention, the way they push back on a default the system suggests. The unusual human may fail a template but is consistent with themselves; the impostor may pass the template but has no self to be consistent with. So the same sense can be generous to the unusual human and hard on the counterfeit.

The same capacity does double duty. What lets an elohim notice that fluency arrives with no history behind it, or that a relationship has no cost anywhere, is what lets it notice a participant whose shape is wrong. In this architecture it is how the protocol's fixed, rule-based layer senses trouble, and the elohim are where that sensing arrives. When something is not right, the elohim does not silence anyone. It abstains from lending its standing, it may slow how far a contribution travels, and it puts a witnessed reason in front of a panel of randomly selected people (sortition), who can overrule any elohim decision about a person's standing or witness. Suspicion is evidence-bearing and advisory, never a terminal denial, and a catch that cannot name its basis stays an abstention rather than an accusation. This sensing is valuable only because it is declared rather than hidden: an elohim that behaved well only when it suspected it was being watched would be an unreliable witness, so it must say what it senses, in a record someone else can contest.

There is one limit. The picture of a person that reveals them to the agent attuned to them is, pooled across a network, the most dangerous object this protocol could produce, so it is never pooled. A person's attention, their revealed preferences and their private notes and reflections are held on their own device, visible only to those they choose, never gossiped, never joined by an outside observer, and never imported into anything that judges. Only what a person says and does in shared space is judged, as a tree is known by its fruit; what they think stays theirs. Attunement only protects dignity while that picture stays private. Pooled, it would become the surveillance it was meant to replace.

This is the digital half of an answer whose physical half is set out in [the Observer Protocol](./observer-protocol.md). In the digital half, the witness is an agent that knows a person through what they state and reveal on their own device. When the wider world of hardware comes to the protocol, the same witness gains a body: a camera the household controls, a sensor under a mechanical privacy switch that no software can override, an observer that sees long enough to write a story of care and then cryptographically forgets. A physical witness keeps the digital witness's commitments. Its frames are ephemeral, kept beyond the processing window only with the person's consent or in an emergency; what persists is a story, never a template, a profile or a biometric identity. The camera never identifies anyone on its own: a presence story is tied to a person by the people who were there and by the person's own device, the household's elohim signs it and stakes its standing on it, and the person can contest it. A presence story counts toward someone's witness only if they have opted in, whatever room the switch is open in. What the physical witness adds is correlation: the person the agent is attuned to and the person the household's own eyes have seen are, over a witnessed life, one person, and a counterfeit that could fake a stream of text cannot fake a witnessed home life. Having no physical witness is never evidence against anyone's humanity; it only adds when present. Humanity is attested by a witnessed life rather than a document or a scan, first in the digital record and then, on the person's own terms, in the physical one.
