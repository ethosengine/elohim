...
id: glossary
cites:
  - "elohim-protocol-manifesto | manifesto | sha256:cd62d3cc869bada5 | path: genesis/docs/content/elohim-protocol/manifesto.md"
  - "constitution | constitution | sha256:1eb96af782012fc6 | path: genesis/docs/content/elohim-protocol/constitution.md"
  - "values-forward | the stances that canonize the common inheritance, self-sealing, and the floor/ceiling | sha256:5f4acd177219031f | path: genesis/docs/content/elohim-protocol/values-forward.md"
---
...
- **the common inheritance** — the value no individual made: nature and land, natural monopolies, network effects, open protocols and standards, knowledge built on prior knowledge, the issuance of money, coordination at scale, and the new value co-created with an AI drawn from all of us. What Henry George called *land*, widened to its modern kin; the test is *reproducibility* — labor and capital are reproducible and earned, while the common inheritance is non-reproducible and positional. The produce of your *labor* is yours; the common inheritance is owed to everyone and returns, on a negotiated schedule, to raise the floor — and to inherit it is also to owe its stewardship onward.
- **digital enclosure** — the Enclosure Acts run again: the common pasture is now a social graph, a protocol layer, or a trained model, fenced off by a platform charging rent on a commons it did not create. But naming it is not the destination — because the digital is now enclosable, and so un-enclosable, it owes the coordination it recovers to the harder socio-ecological floor (land, water, ecology, embodied provision), not merely to fixing digital rents.
