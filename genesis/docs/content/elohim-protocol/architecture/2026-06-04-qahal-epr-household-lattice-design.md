...
cites:
  ...
  - "experience-story-epr-design | the canonical EPR-as-graph-node pattern — defines what an EPR is so §2 can define the Qahal EPR as a composition, not a new primitive | sha256:6a82cd4508e28a39 | path: genesis/docs/content/elohim-protocol/architecture/2026-04-18-experience-story-epr-design.md"
