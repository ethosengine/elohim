...
cites:
  ...
  - "mutual-storage-replication-dwelling-hub-design | first REA compute-commitment instance; intent-first/observed-second pattern that §4 lifts from storage to reach; hub-is-a-role posture the dwelling thesis must reckon with | sha256:1acbeeec8b7a3956 | path: genesis/docs/superpowers/specs/2026-05-28-mutual-storage-replication-dwelling-hub-design.md"
