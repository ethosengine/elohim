...
*how does it travel?* These ten domains (17 seeds) partition the surface cleanly.
...
| **avodah pillar guide** — `app/elohim-app/src/app/avodah/` has models/services/components/routes but no guide; reader infers from code | GUIDE-GAP | OPEN | — |
| **Infrastructure crates** — `elohim-bitswap`, `elohim-compute`, `elohim-cache-core`, `elohim-token`, `elohim-render` mostly lack README/CLAUDE.md; unclear what is load-bearing vs operational | CODE-NO-DOC | OPEN | — |
