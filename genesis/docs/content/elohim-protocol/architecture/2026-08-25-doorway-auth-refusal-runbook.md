...
cites:
  - "doorway-auth-posture-declared-stage | the canon half of this pair — the rule this runbook operationalizes; read it for WHY a refusal is shaped this way, come back here for what to do about one | sha256:472d98d90d8ea8e8 | path: genesis/docs/content/elohim-protocol/architecture/2026-08-25-doorway-auth-posture-declared-stage.md"
