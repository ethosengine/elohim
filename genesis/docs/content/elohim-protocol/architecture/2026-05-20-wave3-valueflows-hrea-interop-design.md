...
Readings: [graduate into, not from](../history/2026-06-02-rno-cross-wave-guidance-graduate-into-not-from.md) — build elohim's coherence and let other hApps graduate in; [R&O reference-implementation positioning](../history/2026-06-02-rno-reference-implementation-positioning.md) — R&O shows that content cannot live on the DHT and a pure-Holochain DNA cannot upgrade without a reset.
