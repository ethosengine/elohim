...
cites:
  ...
  - "map | the product-only D1–D10 lattice with no meta axis that made D4 magnetic for process specs | sha256:4d707bfda967a21a | path: genesis/docs/content/elohim-protocol/architecture/MAP.md"
qualifies:
