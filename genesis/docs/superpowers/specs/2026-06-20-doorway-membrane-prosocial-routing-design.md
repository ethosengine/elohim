...
cites:
  ...
  - "che-network-agency-arc-design | hosted-session / sovereign-peer / delegated-agency + the delegates-compute bounds-gate = the identity-axis authority that travels when routing to a peer | sha256:c318623e18ba56a5 | path: genesis/docs/superpowers/specs/2026-06-10-che-network-agency-arc-design.md"
  ...
  - "non-commons-provide-commitments-design | the replicates-content/commons capacity-variant rationale — the commons-pool membership / opt-in hosting backing (§4·7) | sha256:6d3400a1aca8aa9e | path: genesis/docs/superpowers/specs/2026-06-13-non-commons-provide-commitments-design.md"
