...
cites:
  ...
  - "records-lifecycle-design | canonical D3 seed — the EPR/Event/Resource state machine and the observation→crystallization gradient (1000:1) the FlowEvent→EconomicEvent split rides | sha256:630a34304f64f941 | path: genesis/docs/content/elohim-protocol/architecture/2026-05-24-records-lifecycle-design.md"
  - "wave3-valueflows-hrea-interop-design | the D9 VF/hREA interop boundary — supplies the VF-name-alignment discipline (1:1 mechanical bridge translation) and the substrate≠app-layer warning | sha256:acf7b3bb607fa7bc | path: genesis/docs/content/elohim-protocol/architecture/2026-05-20-wave3-valueflows-hrea-interop-design.md"
