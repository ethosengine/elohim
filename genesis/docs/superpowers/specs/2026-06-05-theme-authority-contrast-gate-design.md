...
cites:
  ...
  - lamad-bundle-gospel | the consumer bundle whose rails change — styles import set gains base.scss; _chrome-binding.scss is the shipped binding the tokens-cells inject as fixture | sha256:1bc6eb8e1c112bc4 | path: app/lamad/CLAUDE.md
