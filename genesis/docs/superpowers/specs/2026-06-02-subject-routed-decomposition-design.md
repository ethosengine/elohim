...
cites:
  - placement | the contract this proposes a subject-class axis section for, mirroring its cluster-state env pointer | sha256:f84d7cb16bea9379
  - genesis/docs/claude.md
  - map | the product-domain lattice this proposes Axis 0 above — subject class before D#+pillar | sha256:de878342b28843e8
