...
cites:
  ...
  - "mutual-storage-replication-dwelling-hub-design | replicates-dwelling + mutuality-audit + intent-first/observed-second — the pattern the ambient-custody responder reuses; gertrude cross-dwelling counterparty stays distinct from intra-household custody | sha256:1acbeeec8b7a3956 | path: genesis/docs/superpowers/specs/2026-05-28-mutual-storage-replication-dwelling-hub-design.md"
