...
cites:
  ...
  - "confession | The warrant and the limit: binding-as-covenant governs why guards must stay short and link rather than lecture; and the total-account-belongs-to-God-alone clause is the tension this ontology mitigates structurally but does not dissolve | sha256:dff3a6835bfa3802 | path: genesis/docs/content/elohim-protocol/confession.md"
