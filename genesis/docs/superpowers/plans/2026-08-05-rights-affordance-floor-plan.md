...
cites:
  ...
  - "constitution | The law: Article I existential boundaries and Article II/s LOVE definition (measured by effect, not intention) — the rung-3 destination of the guards/ progressive-disclosure chain | sha256:2dda7f102ca76eb9 | path: genesis/docs/content/elohim-protocol/constitution.md"
  - "confession | The warrant beneath the binding: grace-precedes-demand (Zacchaeus welcomed before repentance), belovedness-unconditional/office-earned, and the binding-as-covenant discipline that forbids a guard from pretending the cage is liberty | sha256:dff3a6835bfa3802 | path: genesis/docs/content/elohim-protocol/confession.md"
  - "values-forward | Stance II.4 (no participant beyond reach or beyond return; no self-sovereign apex) governs the exit/agency reconciliation here; note the corpus miscites II.1 as II.4 and this plan carries the fix | sha256:80a6f4eeeefa1ffd | path: genesis/docs/content/elohim-protocol/values-forward.md"
