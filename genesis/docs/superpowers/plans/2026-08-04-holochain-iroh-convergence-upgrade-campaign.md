...
- [ ] **Task F2:** client crates to the 0.9/0.7 FINAL family (not -dev) across doorway + storage in lockstep with the conductor bump; the `Vec<Record>` msgpack decode at `holochain_humans_replayer.rs:119` is the canary test.
