...
cites:
  ...
  - "resilience-facings-select-fold-aggregate-design | the §11 select→fold→aggregate framework the card folds descend from; Wave 1.1 proof-gates it | sha256:738c9220d105e9e4 | path: genesis/docs/superpowers/specs/2026-06-19-resilience-facings-select-fold-aggregate-design.md"
