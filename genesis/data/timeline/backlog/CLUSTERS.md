...
|---|---|---|---|---|
| [arch-dataplane-refactor-backlog](epr:arch-dataplane-refactor-backlog) | Dataplane *internal* reshaping — reuse, IoC seams, `p2p/mod.rs` decomposition chain (10→12→15), dev QoL, head-plane scale | 17 | 2026-09-04 | Row 17 (content_store root/version-listing extern) added from the 2026-09-04 rung-5 c3 shift; p2p-design-gate mandatory on pickup |
