...
# HELD (2026-08-21): every scenario has undefined steps (46 total) — story-first placeholder; remove @wip when steps land.
@concern:epistemic-standing @slice:ontology-keel-1 @act:host @e2e @wip
