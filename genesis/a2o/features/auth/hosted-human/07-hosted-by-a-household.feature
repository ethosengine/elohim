...
Feature: Hosted by a household — the compute a newcomer is lent is promised out loud
  ...
  The words this story turns on. The NOTARY is the network's own shared witness: what it
  ...
  Scenario: Closing the account withdraws the promise
    ...
    And the withdrawn commitment is still readable, carrying the date it was made and the date it ended
