#!/bin/bash
# Seed Presences — ContributorPresence records for the population.
#
# Externalized verbatim from genesis/Jenkinsfile (Seed Presences stage,
...
echo ""
DOORWAY_URL="${DOORWAY_HOST}" npx tsx src/seed-presences.ts
