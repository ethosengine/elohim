# Scenarios TODO - Community Leader (Governance)

## Overview

This file tracks which scenario files need to be created for the `community_leader` user type in the `governance` epic.
...
[**TODO**: Check which of these layers are relevant for community_leader, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for community_leader]
...
Feature: [Layer Name] [Epic Context] for Community Leader
  ...
  Background:
    ...
    And the community_leader user is registered in the system
...
[**TODO**: Add any special considerations for community_leader scenarios in governance epic]
