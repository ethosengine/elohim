# Scenarios TODO - Appellant (Governance)

## Overview

This file tracks which scenario files need to be created for the `appellant` user type in the `governance` epic.
...
[**TODO**: Check which of these layers are relevant for appellant, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for appellant]
...
Feature: [Layer Name] [Epic Context] for Appellant
...
[**TODO**: Add any special considerations for appellant scenarios in governance epic]
