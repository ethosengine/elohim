...
org_id: scaling_trust_on_the_web
name: "Scaling trust on the web"
url: "https://www.atlanticcouncil.org/in-depth-research-reports/report/scaling-trust/"
gem_id: "WLYDOBMSGaKYcJTkGrwR"
...
epic_relationships:
  governance:
    inspiration: "[How Scaling trust on the web inspires the governance epic]"
    parallel_work: []
...
[Detailed explanation of how Scaling trust on the web relates to and inspires the governance epic]
...
- **Website:** https://www.atlanticcouncil.org/in-depth-research-reports/report/scaling-trust/
