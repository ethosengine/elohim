...
epic_relationships:
  governance:
    inspiration: "[How Dework inspires the governance epic]"
    parallel_work: []
...
[Detailed explanation of how Dework relates to and inspires the governance epic]
