# Scenarios TODO - Constitutional Council Member (Governance)

## Overview

This file tracks which scenario files need to be created for the `constitutional_council_member` user type in the `governance` epic.
...
[**TODO**: Check which of these layers are relevant for constitutional_council_member, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for constitutional_council_member]
...
Feature: [Layer Name] [Epic Context] for Constitutional Council Member
...
[**TODO**: Add any special considerations for constitutional_council_member scenarios in governance epic]
