# Scenarios TODO - Policy Maker (Governance)

## Overview

This file tracks which scenario files need to be created for the `policy_maker` user type in the `governance` epic.
...
[**TODO**: Check which of these layers are relevant for policy_maker, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for policy_maker]
...
Feature: [Layer Name] [Epic Context] for Policy Maker
...
[**TODO**: Add any special considerations for policy_maker scenarios in governance epic]
