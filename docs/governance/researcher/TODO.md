# Scenarios TODO - Researcher (Governance)

## Overview

This file tracks which scenario files need to be created for the `researcher` user type in the `governance` epic.
...
[**TODO**: Check which of these layers are relevant for researcher, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for researcher]
...
Feature: [Layer Name] [Epic Context] for Researcher
...
[**TODO**: Add any special considerations for researcher scenarios in governance epic]
