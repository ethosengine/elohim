...
1. **Values-Aligned to Love, encoded in the Constitutional binding**  
...
**Taiwan’s Computational Democracy,** using [Poli.is](http://Poli.is) to protect epistemic collaboration under immense psychological nation-state influence. 
