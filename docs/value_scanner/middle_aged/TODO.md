# Scenarios TODO - Middle Aged (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `middle_aged` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for middle_aged, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for middle_aged]
...
Feature: [Layer Name] [Epic Context] for Middle Aged
  As a middle_aged in the value_scanner system
  ...
  Background:
    ...
    And the middle_aged user is registered in the system
...
[**TODO**: Add any special considerations for middle_aged scenarios in value_scanner epic]
