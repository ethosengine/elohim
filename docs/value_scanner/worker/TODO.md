# Scenarios TODO - Worker (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `worker` user type in the `value_scanner` epic.
...
Feature: [Layer Name] [Epic Context] for Worker
  As a worker in the value_scanner system
...
[**TODO**: Add any special considerations for worker scenarios in value_scanner epic]
