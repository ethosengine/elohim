# Scenarios TODO - Person With Disabilities (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `person_with_disabilities` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for person_with_disabilities, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for person_with_disabilities]
...
Feature: [Layer Name] [Epic Context] for Person with Disabilities
  As a person_with_disabilities in the value_scanner system
  ...
  Background:
    ...
    And the person_with_disabilities user is registered in the system
...
[**TODO**: Add any special considerations for person_with_disabilities scenarios in value_scanner epic]
