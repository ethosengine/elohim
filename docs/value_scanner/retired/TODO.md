# Scenarios TODO - Retired (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `retired` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for retired, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for retired]
...
Feature: [Layer Name] [Epic Context] for Retired
  As a retired in the value_scanner system
  ...
  Background:
    ...
    And the retired user is registered in the system
...
[**TODO**: Add any special considerations for retired scenarios in value_scanner epic]
