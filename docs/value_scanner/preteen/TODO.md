# Scenarios TODO - Preteen (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `preteen` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for preteen, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for preteen]
...
Feature: [Layer Name] [Epic Context] for Preteen
  As a preteen in the value_scanner system
  ...
  Background:
    ...
    And the preteen user is registered in the system
...
[**TODO**: Add any special considerations for preteen scenarios in value_scanner epic]
