# Scenarios TODO - Vulnerable Temporary (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `vulnerable_temporary` user type in the `value_scanner` epic.
...
[**TODO**: Add any special considerations for vulnerable_temporary scenarios in value_scanner epic]
