# Scenarios TODO - Child (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `child` user type in the `value_scanner` epic.
...
Feature: [Layer Name] [Epic Context] for Child
  As a child in the value_scanner system
...
[**TODO**: Add any special considerations for child scenarios in value_scanner epic]
