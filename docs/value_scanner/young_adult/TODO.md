# Scenarios TODO - Young Adult (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `young_adult` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for young_adult, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for young_adult]
...
Feature: [Layer Name] [Epic Context] for Young Adult
  As a young_adult in the value_scanner system
  ...
  Background:
    ...
    And the young_adult user is registered in the system
...
[**TODO**: Add any special considerations for young_adult scenarios in value_scanner epic]
