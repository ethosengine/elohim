# Scenarios TODO - Caregiver (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `caregiver` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for caregiver, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for caregiver]
...
Feature: [Layer Name] [Epic Context] for Caregiver
  As a caregiver in the value_scanner system
  ...
  Background:
    ...
    And the caregiver user is registered in the system
...
[**TODO**: Add any special considerations for caregiver scenarios in value_scanner epic]
