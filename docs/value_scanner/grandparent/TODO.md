# Scenarios TODO - Grandparent (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `grandparent` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for grandparent, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for grandparent]
...
Feature: [Layer Name] [Epic Context] for Grandparent
  As a grandparent in the value_scanner system
  ...
  Background:
    ...
    And the grandparent user is registered in the system
...
[**TODO**: Add any special considerations for grandparent scenarios in value_scanner epic]
