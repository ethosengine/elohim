# Scenarios TODO - Elderly (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `elderly` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for elderly, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for elderly]
...
Feature: [Layer Name] [Epic Context] for Elderly
  As a elderly in the value_scanner system
  ...
  Background:
    ...
    And the elderly user is registered in the system
...
[**TODO**: Add any special considerations for elderly scenarios in value_scanner epic]
