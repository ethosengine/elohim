# Scenarios TODO - Adult (Value Scanner)

## Overview

This file tracks which scenario files need to be created for the `adult` user type in the `value_scanner` epic.
...
[**TODO**: Check which of these layers are relevant for adult, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for adult]
...
Feature: [Layer Name] Value Recognition for Adult
  As an adult in the value scanner system
  ...
  Background:
    ...
    And the adult user is registered in the system
...
[**TODO**: Add any special considerations for adult scenarios in value_scanner epic]
