# Scenarios TODO - Customer (Autonomous Entity)

## Overview

This file tracks which scenario files need to be created for the `customer` user type in the `autonomous_entity` epic.
...
[**TODO**: Check which of these layers are relevant for customer, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for customer]
...
Feature: [Layer Name] [Epic Context] for Customer
  As a customer in the autonomous_entity system
  ...
  Background:
    ...
    And the customer user is registered in the system
...
[**TODO**: Add any special considerations for customer scenarios in autonomous_entity epic]
