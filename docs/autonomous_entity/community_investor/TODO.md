# Scenarios TODO - Community Investor (Autonomous Entity)

## Overview

This file tracks which scenario files need to be created for the `community_investor` user type in the `autonomous_entity` epic.
...
[**TODO**: Check which of these layers are relevant for community_investor, then create Gherkin .feature files accordingly]

- [ ] `scenarios/individual.feature` - Personal/individual level BDD scenarios
- [ ] `scenarios/family.feature` - Family unit BDD scenarios
- [ ] `scenarios/neighborhood.feature` - Neighborhood level BDD scenarios
- [ ] `scenarios/community.feature` - Local community BDD scenarios
...
[**TODO**: Check which of these functional domains are relevant for community_investor]

- [ ] `scenarios/workplace_organizational.feature` - Workplace/organizational BDD scenarios
- [ ] `scenarios/educational.feature` - Educational institution BDD scenarios
- [ ] `scenarios/ecological_bioregional.feature` - Ecological/bioregional BDD scenarios
- [ ] `scenarios/cultural_linguistic.feature` - Cultural/linguistic community BDD scenarios
- [ ] `scenarios/industry_sector.feature` - Industry sector BDD scenarios
- [ ] `scenarios/affinity_network.feature` - Affinity network BDD scenarios
...
Feature: [Layer Name] [Epic Context] for Community Investor
  ...
  Background:
    ...
    And the community_investor user is registered in the system
...
[**TODO**: Add any special considerations for community_investor scenarios in autonomous_entity epic]
