# Scenarios TODO - Worker (Autonomous Entity)

## Overview

This file tracks which scenario files need to be created for the `worker` user type in the `autonomous_entity` epic.
...
[**TODO**: Check which of these layers are relevant for worker, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for worker]
...
Feature: [Layer Name] [Epic Context] for Worker
...
[**TODO**: Add any special considerations for worker scenarios in autonomous_entity epic]
