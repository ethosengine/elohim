# Scenarios TODO - Supplier (Autonomous Entity)

## Overview

This file tracks which scenario files need to be created for the `supplier` user type in the `autonomous_entity` epic.
...
[**TODO**: Check which of these layers are relevant for supplier, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for supplier]
...
Feature: [Layer Name] [Epic Context] for Supplier
  ...
  Background:
    ...
    And the supplier user is registered in the system
...
[**TODO**: Add any special considerations for supplier scenarios in autonomous_entity epic]
