# Scenarios TODO - Manager (Autonomous Entity)

## Overview

This file tracks which scenario files need to be created for the `manager` user type in the `autonomous_entity` epic.
...
[**TODO**: Check which of these layers are relevant for manager, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for manager]
...
Feature: [Layer Name] [Epic Context] for Manager
  ...
  Background:
    ...
    And the manager user is registered in the system
...
[**TODO**: Add any special considerations for manager scenarios in autonomous_entity epic]
