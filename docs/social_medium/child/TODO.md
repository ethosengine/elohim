# Scenarios TODO - Child (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `child` user type in the `social_medium` epic.
...
[**TODO**: Check which of these layers are relevant for child, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for child]
...
Feature: [Layer Name] [Epic Context] for Child
...
[**TODO**: Add any special considerations for child scenarios in social_medium epic]
