# Scenarios TODO - Content Creator (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `content_creator` user type in the `social_medium` epic.
...
[**TODO**: Check which of these layers are relevant for content_creator, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for content_creator]
...
Feature: [Layer Name] [Epic Context] for Content Creator
  As a content_creator in the social_medium system
  ...
  Background:
    ...
    And the content_creator user is registered in the system
...
[**TODO**: Add any special considerations for content_creator scenarios in social_medium epic]
