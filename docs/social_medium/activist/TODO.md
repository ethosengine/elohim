# Scenarios TODO - Activist (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `activist` user type in the `social_medium` epic.
...
Feature: [Layer Name] [Epic Context] for Activist
  As a activist in the social_medium system
...
[**TODO**: Add any special considerations for activist scenarios in social_medium epic]
