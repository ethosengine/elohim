# Scenarios TODO - Elder (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `elder` user type in the `social_medium` epic.
...
[**TODO**: Check which of these layers are relevant for elder, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for elder]
...
Feature: [Layer Name] [Epic Context] for Elder
  As a elder in the social_medium system
...
[**TODO**: Add any special considerations for elder scenarios in social_medium epic]
