# Scenarios TODO - Refugee (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `refugee` user type in the `social_medium` epic.
...
[**TODO**: Check which of these layers are relevant for refugee, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for refugee]
...
Feature: [Layer Name] [Epic Context] for Refugee
  As a refugee in the social_medium system
  ...
  Background:
    ...
    And the refugee user is registered in the system
...
[**TODO**: Add any special considerations for refugee scenarios in social_medium epic]
