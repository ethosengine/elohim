# Scenarios TODO - Displaced Person (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `displaced_person` user type in the `social_medium` epic.
...
[**TODO**: Check which of these layers are relevant for displaced_person, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for displaced_person]
...
Feature: [Layer Name] [Epic Context] for Displaced Person
...
[**TODO**: Add any special considerations for displaced_person scenarios in social_medium epic]
