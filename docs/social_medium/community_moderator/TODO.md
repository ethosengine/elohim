# Scenarios TODO - Community Moderator (Social Medium)

## Overview

This file tracks which scenario files need to be created for the `community_moderator` user type in the `social_medium` epic.
...
[**TODO**: Check which of these layers are relevant for community_moderator, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for community_moderator]
...
Feature: [Layer Name] [Epic Context] for Community Moderator
  As a community_moderator in the social_medium system
  ...
  Background:
    ...
    And the community_moderator user is registered in the system
...
[**TODO**: Add any special considerations for community_moderator scenarios in social_medium epic]
