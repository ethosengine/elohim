# Scenarios TODO - Politician (Public Observer)

## Overview

This file tracks which scenario files need to be created for the `politician` user type in the `public_observer` epic.
...
[**TODO**: Check which of these layers are relevant for politician, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for politician]
...
Feature: [Layer Name] [Epic Context] for Politician
...
[**TODO**: Add any special considerations for politician scenarios in public_observer epic]
