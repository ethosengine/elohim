# Scenarios TODO - Citizen (Public Observer)

## Overview

This file tracks which scenario files need to be created for the `citizen` user type in the `public_observer` epic.
...
[**TODO**: Check which of these layers are relevant for citizen, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for citizen]
...
Feature: [Layer Name] [Epic Context] for Citizen
...
[**TODO**: Add any special considerations for citizen scenarios in public_observer epic]
