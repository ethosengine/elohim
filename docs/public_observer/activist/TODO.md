# Scenarios TODO - Activist (Public Observer)

## Overview

This file tracks which scenario files need to be created for the `activist` user type in the `public_observer` epic.
...
[**TODO**: Check which of these layers are relevant for activist, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for activist]
...
Feature: [Layer Name] [Epic Context] for Activist
...
[**TODO**: Add any special considerations for activist scenarios in public_observer epic]
