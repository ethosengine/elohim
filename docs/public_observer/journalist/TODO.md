# Scenarios TODO - Journalist (Public Observer)

## Overview

This file tracks which scenario files need to be created for the `journalist` user type in the `public_observer` epic.
...
[**TODO**: Check which of these layers are relevant for journalist, then create Gherkin .feature files accordingly]
...
[**TODO**: Check which of these functional domains are relevant for journalist]
...
Feature: [Layer Name] [Epic Context] for Journalist
...
[**TODO**: Add any special considerations for journalist scenarios in public_observer epic]
