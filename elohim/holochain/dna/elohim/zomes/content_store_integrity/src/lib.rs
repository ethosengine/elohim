...
// =============================================================================
// EPR Phase 3: Manifest Entry Type
// =============================================================================
pub mod manifest;
...
pub const RISK_TRENDS: [&str; 3] = ["improving", "stable", "declining"];
...
pub const COVERAGE_DECISIONS: [&str; 3] = ["approved", "denied", "partial"];
...
pub const REQUEST_STATUSES: [&str; 4] = ["pending", "active", "archived", "deleted"];

/// Contact preferences
pub const CONTACT_PREFERENCES: [&str; 4] = ["email", "phone", "message", "in-person"];

/// Time preferences
pub const TIME_PREFERENCES: [&str; 4] = ["morning", "afternoon", "evening", "any"];

/// Interaction types
pub const INTERACTION_TYPES: [&str; 3] = ["virtual", "in-person", "hybrid"];
...
/// Challenge states
pub const CHALLENGE_STATES: [&str; 3] = ["in_progress", "completed", "abandoned"];
...
/// Knowledge map types
pub const KNOWLEDGE_MAP_TYPES: [&str; 4] = ["domain", "self", "person", "collective"];

/// Knowledge map visibility levels
pub const KNOWLEDGE_MAP_VISIBILITY: [&str; 4] = ["private", "mutual", "shared", "public"];
...
pub const EXTENSION_VISIBILITY: [&str; 3] = ["private", "shared", "public"];
...
pub const LEARNING_SIGNAL_TYPES: [&str; 5] = [
    "content_viewed",
    "progress_update",
    "quiz_attempt",
    "mastery_achieved",
...
pub enum EntryTypes {
    ...
    // Governance Signals and Cross-cutting Concerns (moved to mishpat DNA for full governance)
...
pub enum LinkTypes {
    ...
    // =========================================================================
    // Lamad: Mediation Log links (cross-cutting, stays in lamad)
    // =========================================================================
    ReactionToMediation, // Reaction (in mishpat DNA) -> MediationLog
...
fn validate_content_succession(
    succession: &ContentSuccession,
    ...
    if succession.renewal_attestation_id.is_empty() {
        return Ok(ValidateCallbackResult::Invalid(
            "ContentSuccession renewal_attestation_id cannot be empty (must have social proof)"
                .to_string(),
        ));
    }
