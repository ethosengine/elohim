...
// The semantic fold (station 4, task 4.3): the declared chunker, which files the fold covers,
// and `index fold|status` — the incremental, fingerprinted, attested store the semantic route
// ranks over.
mod chunk;
pub mod index;
mod surface;
