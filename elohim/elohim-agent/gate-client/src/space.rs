...
//!
//! Type definitions (`SpaceType`, `SpaceContext`) live in `gate-types::space`.
//! This module re-exports those types and owns `detect_from_event` — the
//! detection logic that depends on `RelationalImpactEvent`.
//!
...
pub use gate_types::space::{SpaceContext, SpaceType};
