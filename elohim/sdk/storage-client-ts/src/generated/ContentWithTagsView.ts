 ...
 */
export type ContentWithTagsView = { id: string, hAppId: string, title: string, description: string | null, contentType: string, contentFormat: string, blobHash: string | null, 
/**
