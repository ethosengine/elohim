 ...
 */
export type HouseholdResilienceView = { contentId: string, householdsStewarding: number, householdsReciprocated: number, protectionStatus: string, details: HouseholdResilienceDetails, commitmentBackedReplication: CommitmentBackedReplication, };
