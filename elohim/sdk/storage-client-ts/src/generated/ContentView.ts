...
export type ContentView = { id: string, hAppId: string, title: string, description: string | null, contentType: string, contentFormat: string, blobHash: string | null, blobCid: string | null, contentSizeBytes: number | null, 
/**
