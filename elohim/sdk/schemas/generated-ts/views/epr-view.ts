...
/* Generated from protocol schema: views/epr-view.schema.json -- DO NOT EDIT */
...
export interface EprView {
  ...
  payload: string;
  /**
   * Optional hex-encoded canonical bytes (included when client sets ?includeCanonical=true)
   */
