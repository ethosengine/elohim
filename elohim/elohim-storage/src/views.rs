...
use crate::db::models::{
    Appeal, Challenge, ContentAttestation, CustodianMetrics, Discussion, GovernanceDisposition,
    GovernanceSignal, GovernanceState, Human, LocalSession, ObservationEntry, Precedent, Proposal,
    ProposalOption, RankedVote, Schedule, Statement, StatementVote, Vote,
};
...
// node_stewardship_view_from_with_name → views_convert/shefa.rs
// (re-exported above via pub use crate::views_convert::shefa::...)
