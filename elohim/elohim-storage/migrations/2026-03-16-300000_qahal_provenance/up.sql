...
-- proposals: Source of truth: DHT (Proposal entry in mishpat DNA)
...
-- votes: Source of truth: private source chain (agent-scoped ballot in mishpat DNA)
...
-- ranked_votes: Source of truth: private source chain (agent-scoped ballot in mishpat DNA)
-- Classification: B2 — same pattern as votes
ALTER TABLE ranked_votes ADD COLUMN dht_anchor_hash TEXT;

-- governance_signals: Source of truth: private source chain (agent-scoped reaction in mishpat DNA)
...
-- governance_states: Source of truth: DHT (derived from proposal lifecycle in mishpat DNA)
-- Classification: A2 (Derived) — dht_anchor_hash links to parent proposal ActionHash
ALTER TABLE governance_states ADD COLUMN dht_anchor_hash TEXT;

-- challenges: Source of truth: DHT (Challenge entry in mishpat DNA)
...
-- precedents: Source of truth: DHT (Precedent entry in mishpat DNA)
