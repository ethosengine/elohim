...
#
# Output goes to: elohim/sdk/storage-client-ts/src/generated/
 ...
 *   cd elohim/elohim-storage && ./scripts/generate-types.sh
 *
 * Source: elohim/elohim-storage/src/db/models.rs
 */
