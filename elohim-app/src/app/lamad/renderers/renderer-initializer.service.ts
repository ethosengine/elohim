 ...
 *
 * NOTE: Quiz/assessment content now uses the unified ContentFormatPlugin system
 * with Perseus renderer (see content-io.module.ts). The legacy QuizRendererComponent
 * is deprecated in favor of PerseusRendererComponent.
 */
