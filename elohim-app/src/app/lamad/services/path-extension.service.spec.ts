...
describe('PathExtensionService', () => {
  ...
  describe('addInsertion', () => {
    ...
    it('should add insertion to extension', (done) => {
      ...
      service.addInsertion(testExtensionId, 0, [newStep], 'Adding extra content').subscribe(insertion => {
  ...
  describe('addAnnotation', () => {
    ...
    it('should include additional resources', (done) => {
      service.addAnnotation(testExtensionId, 1, 'note', 'Extra reading', {
        additionalResources: [{ title: 'Extra Resource', resourceId: 'extra-1', description: 'More depth' }]
  ...
  describe('addExclusion', () => {
    ...
    it('should add exclusion to extension', (done) => {
      service.addExclusion(testExtensionId, 1, 'already-mastered', 'I know this already').subscribe(exclusion => {
