...
describe('ProgressMigrationService', () => {
  ...
  describe('migrateAllProgress', () => {
    it('should return empty stats when no progress records exist', () => new Promise<void>(done => {
    ...
    it('should migrate progress for single agent', () => new Promise<void>(done => {
    ...
    it('should migrate progress for multiple agents', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
    ...
    it('should migrate multiple paths for same agent', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
    ...
    it('should handle errors loading paths gracefully', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
    ...
    it('should skip malformed localStorage entries', () => new Promise<void>(done => {
    ...
    it('should merge with existing global progress', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
  ...
  describe('previewMigration', () => {
    it('should return empty preview when no progress', () => new Promise<void>(done => {
    ...
    it('should preview migration stats', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
      localStorageMock['lamad-progress-agent-2-test-path'] = JSON.stringify(mockProgress3);
    ...
    it('should skip existing __global__ records in preview', () => new Promise<void>(done => {
    ...
    it('should estimate content nodes from completed steps', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
  ...
  describe('verifyMigration', () => {
    it('should return valid when all agents have global progress', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
    ...
    it('should return invalid when some agents missing global progress', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
    ...
    it('should count agents correctly', () => new Promise<void>(done => {
      localStorageMock['lamad-progress-agent-1-test-path'] = JSON.stringify(mockProgress1);
      localStorageMock['lamad-progress-agent-1-__global__'] = JSON.stringify({
        ...mockProgress1,
        pathId: '__global__',
