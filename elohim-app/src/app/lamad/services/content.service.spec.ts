...
describe('ContentService', () => {
  ...
  beforeEach(() => {
    ...
    const agentServiceSpyObj = jasmine.createSpyObj('AgentService', ['getAttestations']);
  ...
  describe('getRelatedResource', () => {
    it('should get related resource by index', done => {
      dataLoaderSpy.getContent.and.returnValues(of(mockContent), of(mockRelatedContent));
