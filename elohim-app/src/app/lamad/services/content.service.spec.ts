...
describe('ContentService', () => {
  ...
  describe('getContent', () => {
    it('should get content by ID', () => new Promise<void>(done => {
    ...
    it('should handle content load error', () => new Promise<void>(done => {
  ...
  describe('getRelatedResourceIds', () => {
    it('should get related resource IDs', () => new Promise<void>(done => {
    ...
    it('should return empty array if no related nodes', () => new Promise<void>(done => {
    ...
    it('should handle undefined relatedNodeIds', () => new Promise<void>(done => {
  ...
  describe('getRelatedResource', () => {
    it('should get related resource by index', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValueOnce(of(mockContent)).mockReturnValueOnce(of(mockRelatedContent));
    ...
    it('should return null for invalid index (negative)', () => new Promise<void>(done => {
    ...
    it('should return null for invalid index (too large)', () => new Promise<void>(done => {
    ...
    it('should return null if related content fails to load', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValueOnce(of(mockContent)).mockReturnValueOnce(throwError(() => new Error('Load failed')));
  ...
  describe('searchContent', () => {
    it('should search content by title', () => new Promise<void>(done => {
    ...
    it('should search content by description', () => new Promise<void>(done => {
    ...
    it('should search content by tags', () => new Promise<void>(done => {
    ...
    it('should return all content for empty query', () => new Promise<void>(done => {
    ...
    it('should return all content for whitespace query', () => new Promise<void>(done => {
      service.searchContent('   ').subscribe(results => {
        expect(results.length).toBe(3);
        done();
      });
    ...
    it('should return empty array for no matches', () => new Promise<void>(done => {
    ...
    it('should trim search query', () => new Promise<void>(done => {
      service.searchContent('  TypeScript  ').subscribe(results => {
        expect(results.length).toBe(1);
        expect(results[0].id).toBe('content-1');
        done();
  ...
  describe('getContentByType', () => {
    it('should filter content by type', () => new Promise<void>(done => {
    ...
    it('should handle multiple matches', () => new Promise<void>(done => {
  ...
  describe('additional edge cases', () => {
    it('should handle missing description in search', () => new Promise<void>(done => {
    ...
    it('should handle missing tags in search', () => new Promise<void>(done => {
  ...
  describe('getContentByTag', () => {
    it('should filter content by tag', () => new Promise<void>(done => {
    ...
    it('should return empty array for non-existent tag', () => new Promise<void>(done => {
  ...
  describe('getAllTags', () => {
    it('should return all unique tags sorted alphabetically', () => new Promise<void>(done => {
    ...
    it('should handle nodes without tags', () => new Promise<void>(done => {
      const indexWithNoTags = {
        nodes: [
          {
            id: 'content-1',
  ...
  describe('getAllContentTypes', () => {
    it('should return all unique content types', () => new Promise<void>(done => {
    ...
    it('should skip nodes without contentType', () => new Promise<void>(done => {
      const indexMixed = {
        nodes: [
          {
            id: 'content-1',
  ...
  describe('getContentWithAccessCheck', () => {
    ...
    it('should allow access to commons content', () => new Promise<void>(done => {
    ...
    it('should allow access to content when agent is author', () => new Promise<void>(done => {
    ...
    it('should deny access to private content for non-author', () => new Promise<void>(done => {
      const privateContent: ContentNode = {
        ...mockContent,
        reach: 'private',
        authorId: 'agent-2',
    ...
    it('should allow access for invited agents', () => new Promise<void>(done => {
    ...
    it('should handle not-found error', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(throwError(() => new Error('Not found')));
    ...
    it('should default to commons reach for content without reach property', () => new Promise<void>(done => {
    ...
    it('should allow access when agent reach is sufficient', () => new Promise<void>(done => {
  ...
  describe('extractYouTubeId', () => {
    it('should extract video ID from watch URL', () => new Promise<void>(done => {
    ...
    it('should extract video ID from youtu.be URL', () => new Promise<void>(done => {
      const contentWithYouTube: any = {
        ...mockContentIndex.nodes[0],
        category: 'test',
    ...
    it('should extract video ID from embed URL', () => new Promise<void>(done => {
      const contentWithYouTube: any = {
        ...mockContentIndex.nodes[0],
        category: 'test',
  ...
  describe('getOpenGraphMetadata', () => {
    it('should return Open Graph metadata', () => new Promise<void>(done => {
      const ogMetadata = {
        ogTitle: 'Test Title',
    ...
    it('should return null if no Open Graph metadata', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(of(mockContent));
    ...
    it('should return null on error', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(throwError(() => new Error('Not found')));
  ...
  describe('getActivityPubObject', () => {
    it('should build ActivityPub object', () => new Promise<void>(done => {
    ...
    it('should return null if no activityPubType', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(of(mockContent));
    ...
    it('should include tags as hashtags', () => new Promise<void>(done => {
      const apContent: ContentNode = {
        ...mockContent,
        activityPubType: 'Article',
        tags: ['test', 'example'],
  ...
  describe('getJsonLd', () => {
    it('should return JSON-LD metadata', () => new Promise<void>(done => {
      const linkedData = {
    ...
    it('should return null if no linked data', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(of(mockContent));
  ...
  describe('getDid', () => {
    it('should return DID string', () => new Promise<void>(done => {
    ...
    it('should return null if no DID', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(of(mockContent));
  ...
  describe('getStandardsMetadata', () => {
    it('should return all standards metadata', () => new Promise<void>(done => {
    ...
    it('should return null values for missing metadata', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(of(mockContent));
  ...
  describe('getContentPreviewsForCategory', () => {
    it('should filter content by category', () => new Promise<void>(done => {
      const categoryIndex = {
        nodes: [
          {
            ...mockContentIndex.nodes[0],
    ...
    it('should handle empty results', () => new Promise<void>(done => {
  ...
  describe('searchContentWithPreviews', () => {
    it('should return previews instead of index entries', () => new Promise<void>(done => {
  ...
  describe('getContentPreviewsByType', () => {
    it('should return previews filtered by type', () => new Promise<void>(done => {
  ...
  describe('getRichMediaForCategory', () => {
    it('should categorize rich media content', () => new Promise<void>(done => {
  ...
  describe('getRelatedContentPreviews', () => {
    it('should return previews for related content', () => new Promise<void>(done => {
      const relatedIndex = {
        nodes: [
    ...
    it('should handle content with no related nodes', () => new Promise<void>(done => {
    ...
    it('should handle errors gracefully', () => new Promise<void>(done => {
      dataLoaderSpy.getContent.mockReturnValue(throwError(() => new Error('Not found')));
