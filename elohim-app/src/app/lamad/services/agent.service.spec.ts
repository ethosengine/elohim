...
describe('AgentService', () => {
  ...
  describe('initialization with session service', () => {
    it('should initialize agent from session user', () => new Promise<void>(done => {
  ...
  describe('getProgressForPath', () => {
    it('should get progress from localStorage first', () => new Promise<void>(done => {
    ...
    it('should fall back to JSON file if no localStorage data', () => new Promise<void>(done => {
      dataLoaderSpy.getLocalProgress.mockReturnValue(null);
    ...
    it('should cache progress for subsequent calls', () => new Promise<void>(done => {
    ...
    it('should collect attestations from progress', () => new Promise<void>(done => {
  ...
  describe('completeStep', () => {
    ...
    it('should mark step as completed', () => new Promise<void>(done => {
    ...
    it('should update current step index', () => new Promise<void>(done => {
      service.completeStep('test-path', 2).subscribe(() => {
        const savedProgress = dataLoaderSpy.saveAgentProgress.mock.lastCall[0];
    ...
    it('should create new progress if none exists', () => new Promise<void>(done => {
    ...
    it('should record path started in session on first step', () => new Promise<void>(done => {
      dataLoaderSpy.getAgentProgress.mockReturnValue(of(null as any));
      dataLoaderSpy.getLocalProgress.mockReturnValue(null);
    ...
    it('should keep steps sorted', () => new Promise<void>(done => {
  ...
  describe('updateAffinity', () => {
    ...
    it('should update affinity for a step', () => new Promise<void>(done => {
    ...
    it('should clamp affinity to 0.0-1.0 range (upper)', () => new Promise<void>(done => {
    ...
    it('should clamp affinity to 0.0-1.0 range (lower)', () => new Promise<void>(done => {
      service.updateAffinity('test-path', 1, -2.0).subscribe(() => {
        const savedProgress = dataLoaderSpy.saveAgentProgress.mock.lastCall[0];
    ...
    it('should handle delta updates', () => new Promise<void>(done => {
    ...
    it('should not update affinity without progress', () => new Promise<void>(done => {
      dataLoaderSpy.getAgentProgress.mockReturnValue(of(null as any));
      dataLoaderSpy.getLocalProgress.mockReturnValue(null);
  ...
  describe('saveReflectionResponses', () => {
    ...
    it('should not save reflections without progress', () => new Promise<void>(done => {
      dataLoaderSpy.getAgentProgress.mockReturnValue(of(null as any));
      dataLoaderSpy.getLocalProgress.mockReturnValue(null);
  ...
  describe('getLearningFrontier', () => {
    it('should return active paths from localStorage', () => new Promise<void>(done => {
    ...
    it('should exclude completed paths', () => new Promise<void>(done => {
    ...
    it('should handle malformed localStorage entries', () => new Promise<void>(done => {
    ...
    it('should only include paths for current agent', () => new Promise<void>(done => {
  ...
  describe('clearProgressCache', () => {
    it('should clear the progress cache', () => new Promise<void>(done => {
      service.getProgressForPath('test-path').subscribe(() => {
        service.clearProgressCache();
        dataLoaderSpy.getAgentProgress.mockClear();
