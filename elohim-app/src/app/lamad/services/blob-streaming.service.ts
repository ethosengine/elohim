...
export class BlobStreamingService {
  ...
  // ==========================================================================
  // Legacy Local Manifest Generation (Deprecated - use Doorway URLs)
  // ==========================================================================

  /**
   * @deprecated Use getHlsManifestUrl() instead. Doorway generates manifests server-side.
   *
   * Generate HLS master playlist locally.
   * Kept for backwards compatibility during migration.
   */
  generateHlsPlaylist(blob: ContentBlob, baseUrl: string): string {
    console.warn('[BlobStreaming] generateHlsPlaylist is deprecated. Use getHlsManifestUrl() instead.');
  ...
  /**
   * @deprecated Local manifest generation is deprecated.
   */
  ...
  /**
   * @deprecated Use getDashManifestUrl() instead. Doorway generates manifests server-side.
   *
   * Generate DASH MPD locally.
   * Kept for backwards compatibility during migration.
   */
  generateDashMpd(blob: ContentBlob, baseUrl: string): string {
    console.warn('[BlobStreaming] generateDashMpd is deprecated. Use getDashManifestUrl() instead.');
