...
describe('ExplorationService', () => {
  ...
  describe('exploreNeighborhood', () => {
    it('should explore depth 1 from focus node', () =>
    ...
    it('should return metadata with query stats', () =>
      new Promise<void>(done => {
        service
          .exploreNeighborhood({
            focus: 'node-1',
    ...
    it('should error for non-existent focus node', () =>
      new Promise<void>(done => {
        service
          .exploreNeighborhood({
            focus: 'non-existent',
    ...
    it('should strip content when includeContent is false', () =>
      new Promise<void>(done => {
        service
          .exploreNeighborhood({
            focus: 'node-1',
    ...
    it('should error when graph is empty', () =>
      new Promise<void>(done => {
    ...
    it('should deny depth 2 without proper attestation', () =>
      new Promise<void>(done => {
    ...
    it('should allow depth 2 for graph-researcher', () =>
      new Promise<void>(done => {
        service.setCurrentAgent('researcher-agent');
  ...
  describe('findPath', () => {
    ...
    it('should return edges in path result', () =>
      new Promise<void>(done => {
        service
          .findPath({
            from: 'node-1',
    ...
    it('should error when no path exists', () =>
      new Promise<void>(done => {
    ...
    it('should error for non-existent from node', () =>
      new Promise<void>(done => {
        service
          .findPath({
            from: 'non-existent',
    ...
    it('should error for non-existent to node', () =>
      new Promise<void>(done => {
        service
          .findPath({
            from: 'node-1',
    ...
    it('should use semantic pathfinding when requested', () =>
      new Promise<void>(done => {
        service
          .findPath({
            from: 'node-1',
    ...
    it('should deny pathfinding for non-path-creator', () =>
      new Promise<void>(done => {
  ...
  describe('estimateCost', () => {
    it('should estimate cost for exploreNeighborhood', () =>
      new Promise<void>(done => {
    ...
    it('should indicate canExecute for allowed queries', () =>
      new Promise<void>(done => {
        service.estimateCost('exploreNeighborhood', { depth: 1 }).subscribe(cost => {
    ...
    it('should indicate canExecute false for unauthorized depth', () =>
      new Promise<void>(done => {
    ...
    it('should estimate cost for findPath', () =>
      new Promise<void>(done => {
    ...
    it('should return canExecute false for unknown operation', () =>
      new Promise<void>(done => {
  ...
  describe('getRateLimitStatus', () => {
    it('should return rate limit status for current agent', () =>
      new Promise<void>(done => {
    ...
    it('should return authenticated tier for demo-learner', () =>
      new Promise<void>(done => {
        service.setCurrentAgent('demo-learner');
    ...
    it('should return graph-researcher tier for researcher-agent', () =>
      new Promise<void>(done => {
        service.setCurrentAgent('researcher-agent');
    ...
    it('should return path-creator tier for path-creator-agent', () =>
      new Promise<void>(done => {
        service.setCurrentAgent('path-creator-agent');
  ...
  describe('rate limit enforcement', () => {
    it('should decrement exploration remaining after query', () =>
      new Promise<void>(done => {
    ...
    it('should error when rate limit exceeded', () =>
      new Promise<void>(done => {
  ...
  describe('setCurrentAgent', () => {
    ...
    it('should emit rate limit status update after query', () =>
      new Promise<void>(done => {
        service.setCurrentAgent('researcher-agent');
  ...
  describe('deserializeGraphView', () => {
    it('should convert plain object back to Map', () =>
      new Promise<void>(done => {
        service
          .exploreNeighborhood({
            focus: 'node-1',
  ...
  describe('error handling', () => {
    it('should handle graph loading error gracefully', () =>
      new Promise<void>(done => {
    ...
    it('should handle agent index loading error', () =>
      new Promise<void>(done => {
