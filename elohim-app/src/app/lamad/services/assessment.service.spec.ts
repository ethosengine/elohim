...
describe('AssessmentService', () => {
  ...
  beforeEach(() => {
    ...
    sessionUserSpy = TestBed.inject(SessionHumanService) as {
  ...
  describe('getAssessmentIndex', () => {
    it('should return assessment index from data loader', () =>
  ...
  describe('getAssessmentsByDomain', () => {
    it('should filter assessments by domain', () =>
      new Promise<void>(done => {
  ...
  describe('getAssessment', () => {
    it('should load assessment by ID', () =>
      new Promise<void>(done => {
    ...
    it('should return null for missing assessment', () =>
      new Promise<void>(done => {
  ...
  describe('canAccessAssessment', () => {
    it('should allow access when no prerequisite', () =>
      new Promise<void>(done => {
    ...
    it('should deny access when prerequisite attestation is missing', () =>
      new Promise<void>(done => {
    ...
    it('should allow access when prerequisite attestation is present', () =>
      new Promise<void>(done => {
        dataLoaderSpy.getAssessment.mockReturnValue(of(mockGatedAssessment));
  ...
  describe('startAssessment', () => {
    ...
    it('should use anonymous for missing session ID', () =>
      new Promise<void>(done => {
  ...
  describe('getActiveSession', () => {
    ...
    it('should return active session after starting assessment', () =>
      new Promise<void>(done => {
        service.startAssessment('assessment-1').subscribe(() => {
          service.getActiveSession().subscribe(session => {
  ...
  describe('resumeAssessment', () => {
    ...
    it('should return null when no saved session', () =>
      new Promise<void>(done => {
  ...
  describe('recordResponse', () => {
    it('should record response and increment question index', () =>
      new Promise<void>(done => {
        service.startAssessment('assessment-1').subscribe(() => {
  ...
  describe('completeAssessment', () => {
    ...
    it('should compute scores and return result', () =>
      new Promise<void>(done => {
        service.startAssessment('assessment-1').subscribe(() => {
    ...
    it('should clear session after completion', () =>
      new Promise<void>(done => {
        service.startAssessment('assessment-1').subscribe(() => {
    ...
    it('should handle quadrant interpretation', () =>
      new Promise<void>(done => {
    ...
    it('should handle ranking interpretation', () =>
      new Promise<void>(done => {
        service.startAssessment('assessment-1').subscribe(() => {
          service.recordResponse('q1', 'likert', 7);
  ...
  describe('getMyResults', () => {
    ...
    it('should return sorted results from localStorage', () =>
      new Promise<void>(done => {
