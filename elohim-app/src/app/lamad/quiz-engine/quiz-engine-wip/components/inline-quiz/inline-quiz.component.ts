...
export class InlineQuizComponent implements OnInit, OnDestroy {
  ...
  private loadQuestions(): void {
    ...
    const state = this.streakTracker.startTracking(
      this.contentId,
      this.humanId,
      { targetStreak: this.targetStreak, maxQuestions: this.maxQuestions }
    );
    ...
    // Load question pool
    this.poolService.getPoolForContent(this.contentId)
