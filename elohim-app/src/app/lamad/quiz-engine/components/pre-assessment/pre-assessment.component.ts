        ...
        <div class="offer-phase">
          ...
          <div class="offer-body">
            <p class="offer-message">
              Already familiar with some of this material?
              Take a quick pre-assessment to skip ahead.
            </p>
          ...
          <div class="offer-actions">
            <button class="btn-assess" (click)="onTakeAssessment()">
              Take Pre-Assessment
            </button>
            <button class="btn-skip" (click)="onStartFromBeginning()">
        ...
        <div class="results-phase-content">
          ...
          <div class="results-body">
            @if (skippableSections().length > 0) {
              <p class="results-message">
                Based on your results, you can skip these sections:
              </p>
              ...
              <p class="results-message no-skip">
                The pre-assessment shows you'd benefit from the full learning path.
          ...
          <div class="results-actions">
            @if (skippableSections().length > 0) {
              ...
              <button class="btn-no-skip" (click)="onNoSkip()">
                Don't Skip Any
              </button>
            } @else {
              <button class="btn-start" (click)="onNoSkip()">
                Start Learning
              </button>
            }
          </div>
  ...
  ngOnInit(): void {
    ...
    if (this.skipAheadResult) {
      const preSelected = new Set(
        this.skipAheadResult.skippableSections
          .filter(s => s.recommendSkip)
          .map(s => s.sectionId)
      );
