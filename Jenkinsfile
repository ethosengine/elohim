...
def buildSophiaPlugin() {
    ...
    sh '''
        ...
        cp sophia/packages/sophia-element/dist/sophia-element.umd.js app/elohim-app/src/assets/sophia-plugin/

        # Copy base CSS from main sophia package
        cp sophia/packages/sophia/dist/index.css app/elohim-app/src/assets/sophia-plugin/

        # Copy UMD CSS if it exists (generated by rollup)
        cp sophia/packages/sophia-element/dist/sophia-element.umd.css app/elohim-app/src/assets/sophia-plugin/ 2>/dev/null || true
