 ...
 *
 * Usage:
 *   node app/scripts/check-cem-fresh.mjs           # regenerate (runs full pnpm build per pkg)
 *   node app/scripts/check-cem-fresh.mjs --verify  # diff-only; nonzero exit on drift
 */
