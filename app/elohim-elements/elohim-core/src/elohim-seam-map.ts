...
export const DEFAULT_SEAM_MAP: SeamMap = {
  ...
  seams: [
    ...
    // §3.4
    {
      ...
      home: 'genesis/data/timeline/backlog/modular-runtime-plugin-integrity-feasibility.md',
    ...
    // §3.10
    {
      ...
      home: 'elohim/elohim-storage/CLAUDE.md; genesis/data/timeline/backlog/peer-hoster-async-sync-readiness-assessment.md',
    ...
    // §3.11
    {
      ...
      home: 'elohim/elohim-storage/CLAUDE.md; genesis/docs/content/elohim-protocol/history/2026-06-21-commons-compute-aggregation-readiness-assessment.md',
    ...
    // §3.13
    {
      ...
      home: 'genesis/docs/content/elohim-protocol/history/2026-06-21-commons-compute-aggregation-readiness-assessment.md (R6); BlobStore::store; tiered-quilt-stewardship-design.md',
