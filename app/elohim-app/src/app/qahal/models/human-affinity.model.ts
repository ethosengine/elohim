/**
 * Represents a human's affinity (relationship strength) to content nodes.
 *
 * Affinity is a scalar value from 0.0 to 1.0 that captures the strength
 * of the human's connection to a piece of content. The interpretation of
...
export interface HumanAffinity {
  /** Session ID for session-based humans, AgentPubKey for Holochain humans */
  humanId: string;
