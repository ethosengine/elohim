...
describe('KnowledgeMapService', () => {
  ...
  describe('getMapIndex', () => {
    it('should return index with demo maps', () =>
    ...
    it('should include lastUpdated and totalCount', () =>
      new Promise<void>(done => {
        service.getMapIndex().subscribe(index => {
  ...
  describe('getMyMaps', () => {
    it('should return maps owned by current agent', () =>
      new Promise<void>(done => {
  ...
  describe('getMapsByType', () => {
    it('should filter by domain type', () =>
      new Promise<void>(done => {
    ...
    it('should filter by collective type', () =>
      new Promise<void>(done => {
    ...
    it('should return empty array for person type (no demo person maps)', () =>
      new Promise<void>(done => {
  ...
  describe('getDomainMap', () => {
    it('should return domain map with type narrowing', () =>
      new Promise<void>(done => {
    ...
    it('should return null for non-domain map', () =>
      new Promise<void>(done => {
  ...
  describe('getPersonMap', () => {
    it('should return null for non-person map', () =>
      new Promise<void>(done => {
  ...
  describe('getCollectiveMap', () => {
    it('should return collective map with type narrowing', () =>
      new Promise<void>(done => {
    ...
    it('should return null for non-collective map', () =>
      new Promise<void>(done => {
  ...
  describe('createDomainMap', () => {
    it('should create a new domain map', () =>
      new Promise<void>(done => {
        service
          .createDomainMap({
    ...
    it('should respect visibility parameter', () =>
      new Promise<void>(done => {
        service
          .createDomainMap({
            title: 'Public Map',
  ...
  describe('createPersonMap', () => {
    it('should create a new person map', () =>
      new Promise<void>(done => {
        service
          .createPersonMap({
  ...
  describe('createCollectiveMap', () => {
    it('should create a new collective map', () =>
      new Promise<void>(done => {
        service
          .createCollectiveMap({
    ...
    it('should set default governance', () =>
      new Promise<void>(done => {
        service
          .createCollectiveMap({
            title: 'Test Map',
    ...
    it('should respect custom governance', () =>
      new Promise<void>(done => {
        service
          .createCollectiveMap({
            title: 'Test Map',
  ...
  describe('addNode', () => {
    ...
    it('should return error for non-existent map', () =>
      new Promise<void>(done => {
        service
    ...
    it('should update existing node', () =>
      new Promise<void>(done => {
        ...
        service.getDomainMap('map-domain-elohim-protocol').subscribe(map => {
          ...
          service
            .updateNode('map-domain-elohim-protocol', existingNodeId, {
              title: 'Updated Title',
            })
            .subscribe(node => {
  ...
  describe('updateMastery', () => {
    it('should update mastery level for content node', () =>
      new Promise<void>(done => {
    ...
    it('should return error for non-domain map', () =>
      new Promise<void>(done => {
        const level: MasteryLevel = 'apply';
  ...
  describe('requestConsent', () => {
    it('should handle consent request for person map', () =>
      new Promise<void>(done => {
    ...
    it('should return error for non-person map', () =>
      new Promise<void>(done => {
  ...
  describe('grantConsent', () => {
    it('should return error when not the subject', () =>
      new Promise<void>(done => {
  ...
  describe('requestElohimSynthesis', () => {
    it('should return suggestions for valid map', () =>
      new Promise<void>(done => {
    ...
    it('should return empty array for rejected response', () =>
      new Promise<void>(done => {
        elohimServiceSpy.invoke.mockReturnValue(
          of({
            requestId: 'test-request',
  ...
  describe('setCurrentAgent', () => {
    it('should update current agent ID', () =>
      new Promise<void>(done => {
  ...
  describe('visibility and access control', () => {
    it('should allow owner to view private map', () =>
      new Promise<void>(done => {
        service.getMap('map-domain-elohim-protocol').subscribe(map => {
          expect(map).toBeTruthy();
          done();
    ...
    it('should allow members to view collective map', () =>
      new Promise<void>(done => {
  ...
  describe('affinity calculation', () => {
    it('should recalculate affinity when adding node', () =>
      new Promise<void>(done => {
