...
describe('GovernanceService', () => {
  ...
  describe('getGovernanceIndex', () => {
    it('should return governance index', () =>
    ...
    it('should have challenge count', () =>
      new Promise<void>(done => {
        service.getGovernanceIndex().subscribe(index => {
    ...
    it('should call dataLoader.getGovernanceIndex', () =>
      new Promise<void>(done => {
  ...
  describe('getGovernanceSummary', () => {
    ...
    it('should count voting proposals', () =>
      new Promise<void>(done => {
  ...
  describe('getChallenges', () => {
    ...
    it('should cache challenges after first call', () =>
      new Promise<void>(done => {
  ...
  describe('getChallengesForEntity', () => {
    it('should return challenges for entity', () =>
      new Promise<void>(done => {
    ...
    it('should call dataLoader with correct parameters', () =>
      new Promise<void>(done => {
        service.getChallengesForEntity('content', 'content-123').subscribe(() => {
          expect(dataLoaderMock.getChallengesForEntity).toHaveBeenCalledWith(
            'content',
            'content-123'
          );
          done();
  ...
  describe('getMyChallenges', () => {
    it('should return current user challenges', () =>
      new Promise<void>(done => {
        dataLoaderMock.getChallenges.mockReturnValue(
          of([
            {
  ...
  describe('submitChallenge', () => {
    it('should create new challenge', () =>
      new Promise<void>(done => {
    ...
    it('should set correct challenger', () =>
      new Promise<void>(done => {
        const submission: ChallengeSubmission = {
          entityType: 'content',
          entityId: 'content-123',
    ...
    it('should clear cache after submission', () =>
      new Promise<void>(done => {
        const submission: ChallengeSubmission = {
          entityType: 'content',
          entityId: 'content-123',
  ...
  describe('getProposalsByStatus', () => {
    it('should call dataLoader with status', () =>
      new Promise<void>(done => {
  ...
  describe('getActiveProposals', () => {
    it('should return voting proposals', () =>
      new Promise<void>(done => {
  ...
  describe('getMyProposals', () => {
    it('should return current user proposals', () =>
      new Promise<void>(done => {
        dataLoaderMock.getProposals.mockReturnValue(
          of([
            { ...mockProposal, proposer: { agentId: 'test-session-123', displayName: 'Me' } },
            {
              ...mockProposal,
              id: 'proposal-2',
              proposer: { agentId: 'other-user', displayName: 'Other' },
            },
          ])
        );
  ...
  describe('getPrecedentsByBinding', () => {
    it('should call dataLoader with binding level', () =>
      new Promise<void>(done => {
  ...
  describe('getConstitutionalPrecedents', () => {
    it('should return constitutional precedents', () =>
      new Promise<void>(done => {
  ...
  describe('searchPrecedents', () => {
    it('should filter precedents by title', () =>
      new Promise<void>(done => {
  ...
  describe('getDiscussionsForEntity', () => {
    it('should return discussions for entity', () =>
      new Promise<void>(done => {
    ...
    it('should call dataLoader with correct parameters', () =>
      new Promise<void>(done => {
        service.getDiscussionsForEntity('content', 'content-123').subscribe(() => {
          expect(dataLoaderMock.getDiscussionsForEntity).toHaveBeenCalledWith(
            'content',
            'content-123'
          );
          done();
  ...
  describe('getGovernanceState', () => {
    it('should return governance state for entity', () =>
      new Promise<void>(done => {
    ...
    it('should call dataLoader with entity type and ID', () =>
      new Promise<void>(done => {
  ...
  describe('getEffectiveStatus', () => {
    it('should return state status if exists', () =>
      new Promise<void>(done => {
    ...
    it('should return unreviewed if no state', () =>
      new Promise<void>(done => {
  ...
  describe('isEntityChallenged', () => {
    it('should return true if active challenges exist', () =>
      new Promise<void>(done => {
    ...
    it('should return false if no active challenges', () =>
      new Promise<void>(done => {
        dataLoaderMock.getChallengesForEntity.mockReturnValue(
          of([{ ...mockChallenge, status: 'resolved' }])
        );
  ...
  describe('getChallengesNearingDeadline', () => {
    it('should return challenges approaching deadline', () =>
      new Promise<void>(done => {
    ...
    it('should not return challenges beyond deadline window', () =>
      new Promise<void>(done => {
  ...
  describe('clearCache', () => {
    ...
    it('should clear proposals cache', () =>
      new Promise<void>(done => {
        service.getProposals().subscribe(() => {
          expect(dataLoaderMock.getProposals).toHaveBeenCalledTimes(1);
    ...
    it('should clear precedents cache', () =>
      new Promise<void>(done => {
        service.getPrecedents().subscribe(() => {
          expect(dataLoaderMock.getPrecedents).toHaveBeenCalledTimes(1);
