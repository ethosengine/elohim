...
describe('GateFeedbackTriggerComponent', () => {
  ...
  it('should render the trigger button', () => {
    const btn = fixture.nativeElement.querySelector('[data-testid="feedback-trigger-btn"]');
  ...
  it('should not show menu initially', () => {
    const menu = fixture.nativeElement.querySelector('[data-testid="feedback-trigger-menu"]');
  ...
  it('should show Flag, Challenge, Feedback, Report Issue labels', () => {
    ...
    const items = fixture.nativeElement.querySelectorAll('[data-testid^="feedback-menu-item-"]');
    const labels = Array.from(items).map((el: Element) => (el as HTMLElement).textContent?.trim());
  ...
  it('should close modal when modal emits closed', () => {
    ...
    expect(
      fixture.nativeElement.querySelector('[data-testid="feedback-modal-backdrop"]')
    ).toBeTruthy();
  ...
  it('should forward feedbackPosted from modal with feedbackType included', () => {
    ...
    const challengeItem: HTMLButtonElement = fixture.nativeElement.querySelector(
