...
| Legacy reference notes | git history of `app/lamad/docs/` (island retired 2026-06-11 — recomposed into the bloom-mastery seed, two `history/` records, and timeline backlog entries; see `genesis/docs/content/elohim-protocol/history/2026-06-11-lamad-mvp-implementation-arc.md` and, for why the model is a flat `contentType` rather than a class tree, `genesis/docs/content/elohim-protocol/history/2026-06-11-lamad-deleted-concepts-2024.md`) |
