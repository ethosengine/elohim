 ...
 *
 * Calls doorway `/api/v1/mastery/*` endpoints, implementing ILearnerBackend.
 *
 * P-disposition: Moved from @app/elohim/services (Slice 2.1c).
 * Registered in lamad's app.config.ts via { provide: LEARNER_BACKEND, useClass: ... }.
 */
