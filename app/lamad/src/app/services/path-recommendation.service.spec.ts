...
import type {
  DiscoveryProfile,
  DiscoveryResult,
} from '../quiz-engine/models/discovery-assessment.model';
...
describe('PathRecommendationService', () => {
  ...
  describe('empty profile', () => {
    it('should return empty when totalAssessments is 0', () =>
    ...
    it('should not call dataLoader when profile has no assessments', () =>
      new Promise<void>(done => {
        const profile = buildProfile({ totalAssessments: 0 });
  ...
  describe('tag overlap scoring', () => {
    it('should score paths by category tag overlap', () =>
      new Promise<void>(done => {
    ...
    it('should rank paths with more tag matches higher', () =>
      new Promise<void>(done => {
    ...
    it('should include matched categories in recommendation', () =>
      new Promise<void>(done => {
  ...
  describe('framework affinity', () => {
    it('should boost paths with framework-affinity tags', () =>
      new Promise<void>(done => {
  ...
  describe('intimate path filtering', () => {
    it('should exclude paths with intimate visibility', () =>
      new Promise<void>(done => {
    ...
    it('should exclude paths with private visibility', () =>
      new Promise<void>(done => {
  ...
  describe('sorting', () => {
    it('should return recommendations sorted by relevance descending', () =>
      new Promise<void>(done => {
        const paths = [
  ...
  describe('getTopRecommendation', () => {
    it('should return the highest-scored recommendation', () =>
      new Promise<void>(done => {
        const paths = [
    ...
    it('should return null when no recommendations match', () =>
      new Promise<void>(done => {
        const paths = [
    ...
    it('should return null when profile has no assessments', () =>
      new Promise<void>(done => {
        const profile = buildProfile({ totalAssessments: 0 });
  ...
  describe('reason text', () => {
    it('should include matched category names in reason', () =>
      new Promise<void>(done => {
        const path = buildPathEntry({
          id: 'path',
          title: 'Path',
