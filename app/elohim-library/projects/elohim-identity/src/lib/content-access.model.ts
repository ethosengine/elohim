 ...
 *
 * Rehomed to @elohim/identity (from @app/lamad/models/content-access.model)
 * as part of Slice 2.3 cross-pillar import cleanup. Access control types are
 * an identity-layer concern — they define what a session human (or Holochain
 * identity) can do, not a lamad-specific concept.
 *
 * Examples:
