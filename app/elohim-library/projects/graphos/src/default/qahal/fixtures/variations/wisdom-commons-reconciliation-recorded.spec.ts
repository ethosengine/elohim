...
import { wisdomCommonsReconciliationRecorded } from './wisdom-commons-reconciliation-recorded';

describe('wisdom-commons-reconciliation-recorded variation fixture', () => {
  const scene: Scene = wisdomCommonsReconciliationRecorded;
