...
export const MAPPINGS = [
  ...
  { fromGlob: 'a2o/features/lms/*.feature',
  ...
  { fromGlob: 'a2o/features/rms/*.feature',
    toDir: 'domains/economy/stories/',
    titleFn: (name) => `III. Domains / Economy (Shefa) / Stories / ${name}` },
  { fromGlob: 'a2o/features/wms/*.feature',
    toDir: 'domains/work/stories/',
    titleFn: (name) => `III. Domains / Work (Avodah) / Stories / ${name}` },
