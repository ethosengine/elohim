...
<p align="center"><em>At the center, an elohim observer sits beside us — a young Wisdom with a quill, a witness to our life — and writes the REA ledger of care: who tended, who taught, who mended, every entry attested. Near her, a life well lived; above, the council carries the deliberative weight, balance, and judgments no single person need hold, so the people are freed to live while the machines absorb the variety. She keeps the substrate of a commons new but ancient, and tends with us its living tree of knowledge. (Concept illustration.)</em></p>

## About

The *Elohim Protocol* is digital infrastructure organized around love as a fundamental operating principle — implemented through distributed architecture, and protected by autonomous AI agents that serve human flourishing rather than institutional power.
...
> The Judeo-Christian ontology and thought here come *with the founder* — a chosen lens, not a claim on the territory. A peer project approaching this same entity through a different tradition — where it is called a [Kami](https://arxiv.org/abs/2602.14940), a term coined by Botao 'Amber' Hu in *[Kami of the Commons](https://arxiv.org/abs/2602.14940)* (Feb 2026) — lives at [civic.ai](https://civic.ai) ([audreyt/civic.ai](https://github.com/audreyt/civic.ai)), from Audrey Tang and Caroline Green. Different ontology, kindred aim: two lenses arriving separately at the same shape — bounded, inspectable, community-governed AI held as a commons.
...
AI changes that equation — it collapses the coordination cost that made the full stool impossible for small teams: the overhead of holding information, value, and governance in tension all at once. The vision was never the scarce part.
...
**Three Inseparable Dimensions**: Every piece of content in the protocol carries knowledge, value, and governance — coupled at the architectural level before anything is created or distributed. No value-blind content. No governance-free content. These three-legged records are called **EPRs** (Elohim Protocol Records); they are the protocol's primitive unit of meaning.
...
The substrate is a **layered, content-addressed stack** — Holochain is *one* layer of it (the integrity/notary floor), not the whole thing. "Runs on Holochain" is about a quarter of the story:
...
![Buy me a](https://img.shields.io/badge/Buy_me_a-6B6157?style=for-the-badge&labelColor=6B6157) [![Buy me a coffee](https://img.shields.io/badge/-%24_COFFEE-B8664F?style=for-the-badge)](https://www.buymeacoffee.com/mbd06b) [![Buy me a coffee with Ethereum](https://img.shields.io/badge/-%CE%9E_COFFEE-B8664F?style=for-the-badge)](https://commerce.coinbase.com/checkout/81641625-3924-4635-93e8-4d01caae73fd)
