...
archetype_name: "Franchise Operator"
...
# Franchise Operator - Autonomous Entity

## Archetype

[**TODO**: Define the archetype for this user type. Describe who they are, their role in the autonomous_entity epic, age/demographics if relevant, and their relationship to the protocol.]

## Core Needs

[**TODO**: Identify 3-5 core needs this user type has that the autonomous_entity epic addresses:]
